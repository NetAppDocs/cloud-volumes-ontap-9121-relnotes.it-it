...
. La creazione di volumi FlexVol fino alle dimensioni massime di 300 TiB è supportata mediante System Manager a partire da Cloud Volumes ONTAP 9.12.1 P2.
